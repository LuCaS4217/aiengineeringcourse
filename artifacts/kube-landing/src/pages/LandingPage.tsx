                ...
                <StaggerItem className="group flex flex-col sm:flex-row bg-surface border border-outline-variant/30 hover:border-electric-blue transition-all duration-300">
                  ...
                  <div className="p-8 sm:p-10 flex-1 space-y-5">
                    ...
                    <div className="flex gap-5 pt-4">
                      <Share2 className="w-5 h-5 text-outline-variant group-hover:text-electric-blue transition-colors cursor-pointer" />
                      <Code className="w-5 h-5 text-outline-variant group-hover:text-electric-blue transition-colors cursor-pointer" />
                    </div>
                  </div>
                </StaggerItem>
